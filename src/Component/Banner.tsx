...
const Banner = () => {
  return (
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center px-4">
      <div className="">
        <h2 className="font-extrabold font-inter xl:text-[60px] text-center md:text-start">
          Build Your Ideal <br />
        ...
        <div className="mt-8 flex justify-center md:justify-start">
          <button
            className="
          bg-[linear-gradient(90deg,#FF5722_0%,#D81B7E_50%,#7C3AED_100%)] hover:bg-[#DB2777] text-[#FFFFFF] py-1 px-3 md:py-2 md:px-6 rounded-xl"
          >
            Explore Technologies
          </button>
          <button className="ml-4 bg-[#F1F5F9] hover:bg-[linear-gradient(90deg,#FF5722_0%,#D81B7E_50%,#7C3AED_100%)] hover:text-[#FFFFFF] py-1 px-3 md:py-2 md:px-6 rounded-xl">
            Learn More
          </button>
        </div>
      </div>
